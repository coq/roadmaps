...
- [x] [PR#158](https://github.com/coq/coq/pull/158): Fixing the
...
- [ ] :grey_exclamation: [PR#204](https://github.com/coq/coq/pull/204)
...
- [x] Rename some modules to avoid conflicts with the ocaml compiler.
...
- [x] :grey_exclamation: [PR#117](https://github.com/coq/coq/pull/117):
  ...
  Reimplemented and merged as [PR#231](https://github.com/coq/coq/pull/231)
...
- [x] [PR#142](https://github.com/coq/coq/pull/142): Patterns in
...
- [x] [PR#79](https://github.com/coq/coq/pull/79) Assume
...
- [x] Search has an option to print only the list of names found (C.
  Pit-Claudel).

- [x] New flag "Shrink Abstract" that minimizes proofs generated by the abstract
  ...
  not specifying its proof term). [PR#218](https://github.com/coq/coq/pull/218)
